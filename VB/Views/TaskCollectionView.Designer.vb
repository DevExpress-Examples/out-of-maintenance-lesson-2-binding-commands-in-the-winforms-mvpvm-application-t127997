...
Namespace MyMvpvmApplication.Views
	Public Partial Class TaskCollectionView
		...
		Private Sub InitializeComponent()
            ...
            Me.biAddTask = New DevExpress.XtraBars.BarButtonItem()
            Me.biDeleteTask = New DevExpress.XtraBars.BarButtonItem()
            ...
            Me.barManager1.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.biAddTask, Me.biDeleteTask})
            ...
            Me.bar1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.biAddTask), New DevExpress.XtraBars.LinkPersistInfo(Me.biDeleteTask)})
            Me.bar1.Text = "Tools"
            '
            'biAddTask
            '
            Me.biAddTask.Caption = "Add Task"
            Me.biAddTask.Id = 0
            Me.biAddTask.Name = "biAddTask"
            '
            'biDeleteTask
            '
            Me.biDeleteTask.Caption = "Remove Task"
            Me.biDeleteTask.Id = 1
            Me.biDeleteTask.Name = "biDeleteTask"
            '
            'barDockControlTop
            '
...
#End Region
        ...
        Private biAddTask As DevExpress.XtraBars.BarButtonItem
        Private biDeleteTask As DevExpress.XtraBars.BarButtonItem
